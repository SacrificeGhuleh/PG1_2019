...
int SimpleGuiDX11::MainLoop() {
  ...
  BOOL r = SetThreadPriority((HANDLE) producer_thread.native_handle(), THREAD_PRIORITY_BELOW_NORMAL);
  ...
  while (msg.message != WM_QUIT) {
    ...
    
    {
      ...
      HRESULT hr = g_pd3dDeviceContext->Map(tex_id_, 0, D3D11_MAP_WRITE_DISCARD, 0,
